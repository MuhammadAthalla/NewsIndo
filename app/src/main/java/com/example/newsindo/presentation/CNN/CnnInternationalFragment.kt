 ...
 * Use the [CnnInternationalFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class CnnInternationalFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        newsViewModel.getCNNInternasional()
        val mAdapter = NewsAdapter()

        newsViewModel.getCNNInternasional.observe(viewLifecycleOwner){ news ->
