...
import com.example.newsindo.databinding.FragmentHukumBinding
...
class hukumFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        newsViewModel.getAntaraHukum()
        val mAdapter = NewsAdapter()

        newsViewModel.getAntaraHukum.observe(viewLifecycleOwner){ news ->
